...
<img src="image/cfs_example.png" width="70%" aligin="middle" text="Examples of counterfactals for sentiment analysis (top) and natural language model (bottom) respectively.">
